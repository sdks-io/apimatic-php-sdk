...
/**
 * The Code Generation structure encapsulates all the  the details of an SDK generation performed by a
 * user.
 */
class UserCodeGeneration implements \JsonSerializable
{
    /**
     * @var string
     */
