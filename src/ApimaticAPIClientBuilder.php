...
class ApimaticAPIClientBuilder
{
    /**
     * @var array
     */
    ...
    /**
     * @see ApimaticAPIClientBuilder::customHeaderAuthenticationCredentials
     *
    ...
    public function build(): ApimaticAPIClient
    {
        return new ApimaticAPIClient($this->config);
    }
}
